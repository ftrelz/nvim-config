---@class fred.utils.telescope.opts
---@field cwd? string|boolean
---@field show_untracked? boolean

---@class fred.utils.telescope
---@overload fun(builtin:string, opts?:fred.utils.telescope.opts)
...
---@param opts? fred.utils.telescope.opts
function M.telescope(builtin, opts)
  local params = { builtin = builtin, opts = opts }
  return function()
    builtin = params.builtin
    opts = params.opts
    opts = vim.tbl_deep_extend("force", { cwd = vim.uv.cwd() }, opts or {}) --[[@as fred.utils.telescope.opts]]
